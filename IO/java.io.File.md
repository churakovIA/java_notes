# Ввод и вывод. Класс [**java.io.File**][1]
### Основные методы класса [**java.io.File**][1]
Методы анализа файла | Описание
--- | ---
...
Методы манипулирования | Описание
--- | ---
